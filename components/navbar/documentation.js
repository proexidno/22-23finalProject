...
export default function Documentation() {
    return (
        <Sheet className="leading-loose">
            ...
            <SheetContent position={"left"} className="w-1/2 md:w-1/3">
                <SheetHeader>
                    ...
                    <SheetDescription>
                        ...
                        <Link href={"/docs"} className="mt-4 inline-flex items-center justify-center rounded-md text-sm font-medium bg-primary h-10 py-2 px-4 text-white">Go to full docs</Link>
                    </SheetDescription>
                </SheetHeader>
            </SheetContent>
        </Sheet>
